...
public class TokenUtil {
     ...
     * @throws TokenNotGeneratedException Token is not generated by user is null.
     */
    public static String generateToken(UserInfo user) throws JoseException, TokenNotGeneratedException {
        if (user == null)
            throw new TokenNotGeneratedException("User is null, token is not generated.");
